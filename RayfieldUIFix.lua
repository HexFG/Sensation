...
local RayfieldLibrary = {
	...
	Theme = {
		...
		["Fatality"] = {
			...
			TabBackground = Color3.fromRGB(25, 23, 47),
			TabStroke = Color3.fromRGB(47, 44, 79),
			TabBackgroundSelected = Color3.fromRGB(33, 25, 68),
			TabTextColor = Color3.fromRGB(180, 180, 190),
			SelectedTabTextColor = Color3.fromRGB(180, 180, 190),

			ElementBackground = Color3.fromRGB(30, 23, 66),
			ElementBackgroundHover = Color3.fromRGB(25, 58, 100),
			SecondaryElementBackground = Color3.fromRGB(30, 23, 66),
			ElementStroke = Color3.fromRGB(47, 44, 79),
			SecondaryElementStroke = Color3.fromRGB(47, 44, 79),

			SliderBackground = Color3.fromRGB(30, 23, 66),
			SliderProgress = Color3.fromRGB(194, 5, 82),
			SliderStroke = Color3.fromRGB(47, 44, 79),

			ToggleBackground = Color3.fromRGB(30, 23, 66),
			ToggleEnabled = Color3.fromRGB(194, 5, 82),
			ToggleDisabled = Color3.fromRGB(138, 1, 55),
			ToggleEnabledStroke = Color3.fromRGB(194, 5, 82),
			ToggleDisabledStroke = Color3.fromRGB(138, 1, 55),
			ToggleEnabledOuterStroke = Color3.fromRGB(47, 44, 79),
			ToggleDisabledOuterStroke = Color3.fromRGB(47, 44, 79),

			DropdownSelected = Color3.fromRGB(194, 5, 82),
			DropdownUnselected = Color3.fromRGB(30, 23, 66),

			InputBackground = Color3.fromRGB(30, 23, 66),
			InputStroke = Color3.fromRGB(47, 44, 79),
			PlaceholderColor = Color3.fromRGB(150, 150, 150)
		},
	}
}
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Show Menu'.", Duration = 7, Image = 4400697855})
		else
...
function Window:CreateTab(Name, Image, Ext)
	...
	function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
		ColorPickerSettings.Name = ColorPickerSettings.Name or "Picker"
		ColorPickerSettings.Color = ColorPickerSettings.Color or Color3.fromRGB(255, 255, 255)
		ColorPickerSettings.Flag = ColorPickerSettings.Flag or "picker1"
	...
	function Tab:CreateLabel(LabelText : string, Icon: number, Color : Color3, IgnoreTheme : boolean)
		...
		IgnoreTheme = IgnoreTheme or false
	...
	function Tab:CreateParagraph(ParagraphSettings)
		ParagraphSettings.Title = ParagraphSettings.Title or "Paragraph"
		ParagraphSettings.Content = ParagraphSettings.Content or "Paragraph Example"
	...
	function Tab:CreateInput(InputSettings)
		...
		InputSettings.PlaceholderText = InputSettings.PlaceholderText or ""
		InputSettings.RemoveTextAfterFocusLost = InputSettings.RemoveTextAfterFocusLost or false
		InputSettings.Flag = InputSettings.Flag or "input1"
		...
		Input.InputFrame.InputBox.FocusLost:Connect(function()
			...
			print(InputSettings.Name.." Callback Error " ..tostring(Response))
			task.wait(0.5)
			Input.Title.Text = InputSettings.Name
	...
	function Tab:CreateDropdown(DropdownSettings)
		...
		DropdownSettings.Flag = DropdownSettings.Flag or "dropdown1"
	...
	function Tab:CreateToggle(ToggleSettings)
		...
		ToggleSettings.Flag = ToggleSettings.Flag or "toggle1"
		...
		Toggle.Interact.MouseButton1Click:Connect(function()
			...
			if not Success then
				...
				print(ToggleSettings.Name.." Callback Error " ..tostring(Response))
				task.wait(0.5)
				Toggle.Title.Text = ToggleSettings.Name
				TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
				TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 0}):Play()
	...
	function Tab:CreateSlider(SliderSettings)
		...
		SliderSettings.CurrentValue = SliderSettings.CurrentValue or 1
		SliderSettings.Flag = SliderSettings.Flag or "slider1"
